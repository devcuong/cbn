...
class Schema
{
    ...
    function generate_schema_for_vid_videos($data, $page)
    {
        ...
        if ($page == "videos") {
            ...
            $logo = array(
                "@type" => "ImageObject",
                "url" => "https:" . $serverName . "/web/public/images/logo.png",
                "width" => 341,
                "height" => 341
            );
            $publisher = array(
            ...
            $image = array(
                "@type" => "ImageObject",
                "url" => "https:" . $serverName . "/web/public/images/banner.png",
                "width" => 1105,
                "height" => 341
            );
            $dataSchema = array(
    ...
    function generate_schema_for_review($dataCongTy, $dataReview)
    {
        ...
        while ($r = mysqli_fetch_array($dataCongTy)) {
            $tenCongTy = $r["tencongty"];
            $hinhCongTy = "https:" . $serverName . "/web/public/asset/companies/logo/" . $r["logo"];
            $ratingValue = (float) $r["rate"];
        }
        $itemReviewed = array(
            "@type" => "Organization",
