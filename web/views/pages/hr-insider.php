...
<nav class="breadcrumb m-b-10 m-t-10" aria-label="breadcrumbs">
	<ul>
		...
		<li class="is-active"><a href="#"> <span>HR Insider</span>
		</a></li>
	</ul>
</nav>
<div class="columns">
	<div class="column is-two-thirds">
		...
		<div class="news media news-item is-hidden-tablet media-mobile">
			<a
				...
				src="<?php echo $servername ?>/web/public/asset/news/<?php echo $row["thumbnail"] ?>"
	...
	<div class="column">
		<?php require_once "./web/views/partials/right-news.php"?>
	</div>
</div>
